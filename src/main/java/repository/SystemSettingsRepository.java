...
public class SystemSettingsRepository {
	...
	public void save(Connection con, SystemSettings s) throws Exception {
		...
		try (PreparedStatement ps = con.prepareStatement(UPSERT)) {
			...
			ps.setString(10, s.getNumberingFy() != null ? s.getNumberingFy() : "");

			ps.setInt(11, s.getLastSeqInv());
			ps.setInt(12, s.getLastSeqPi());
			ps.setInt(13, s.getLastSeqCn());
			ps.setInt(14, s.getLastSeqDn());
			ps.setInt(15, s.getLastSeqQtn());
			ps.setInt(16, s.getLastSeqPo());
			ps.setInt(17, s.getLastSeqJob());
			ps.setInt(18, s.getLastSeqTkt());
			ps.setInt(19, s.getLastSeqDc());
			ps.setInt(20, s.getLastSeqEwb());

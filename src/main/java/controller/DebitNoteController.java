...
public class DebitNoteController {
    ...
    @FXML
    private void handleSaveDebitNote(ActionEvent event) {
        ...
        System.out.println("Debit Note Saved: " + amountField.getText() + " for " + selectedClient.getBusinessName());
        
        Stage stage = (Stage) amountField.getScene().getWindow();
        Toast.show(stage, "Debit Note saved successfully!");

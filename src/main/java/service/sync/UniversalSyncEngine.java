...
public final class UniversalSyncEngine {
	...
	public static SyncReport syncAllPending() {
		...
		try {
			...
			report.numberSequencesSynced = NumberSequenceSupabaseSync.syncLocalToRemoteIfChanged(http);
			...
			report.othersSynced = OtherPendingEntitiesSync.syncAll(http, report);
